package com.marcospascoski.cursomc.resources.exceptions;
...
import com.marcospascoski.cursomc.services.exceptions.FileException;
...
public class RecourceExceptionHandler {
	...
	public ResponseEntity<StandardError> AamazonService(AmazonServiceException e, HttpServletRequest request){
