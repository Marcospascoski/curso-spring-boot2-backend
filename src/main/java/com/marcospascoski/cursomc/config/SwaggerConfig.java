package com.marcospascoski.cursomc.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.marcospascoski.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do desenvolvimento backend com Spring Boot",
				"Esta API é utilizada no desenvolvimento com Spring Boot", 
				"Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact("Marcos Pascoski", "facebook.com/marcospascosk", "marcospascoski@gmail.com"),
				"Permitido o uso para estudo", 
				"https://www.udemy.com/terms", 
