...
import com.marcospascoski.cursomc.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null,"Maria Pask", "marcospascoski@gmail.com",pe.encode("123"), "1345678911", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("789458945","456125612"));
		
		Cliente cli2 = new Cliente(null, "marcos", "mluciopascoski@gmail.com",pe.encode("123"), "31628382740", TipoCliente.PESSOAFISICA);
		...
		Endereco e3 = new Endereco(null, "Av. Matos", "1565", "N", "Centro", "78575-000", cli2, c2);
